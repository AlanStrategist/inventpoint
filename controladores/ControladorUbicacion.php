...
public function index()
    ...
    <?php
            ...
            if (isset($alerta)) {
                ...
                header("Location: ../vista/categorias/ubicacion/index.php?clave=" . $clave . "&alerta=" . $alerta);
...
if ($nombresbd>0){
			...
			header("Location: ./ControladorUbicacion.php?operacion=index&autorizo=autorizo&alerta=nombredu");	
...
header("Location: ControladorUbicacion.php?operacion=index&alerta=alertaub&autorizo=autorizo");
	
	} else { 
	 
header("Location: ./ControladorUbicacion.php?operacion=index&alerta=no&autorizo=autorizo"); 
			}
                     }
				}	
...
header("Location: ControladorUbicacion.php?operacion=index&alerta=modisi&autorizo=autorizo") 
;		 #
	} else { 
		
header("Location: ControladorUbicacion.php?operacion=index&alerta=modino&autorizo=autorizo");
	}  
} 
