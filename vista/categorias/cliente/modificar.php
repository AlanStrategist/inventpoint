    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">
          <h5 class="title">Modificar Cliente</h5>
        </div>
        <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-5 pr-1">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nombre" value="<?=$data['nombre']?>" title="Nombre completo" minlength="5" maxlength="20" class="form-control" placeholder="Gonzalo González" required="required">
              ...
              <div class="col-md-3 px-1">
                <div class="form-group">
                  ...
                  <input type="text" name="cedula" value="<?=$data['cedula']?>" minlength="5" maxlength="23" class="form-control" placeholder="33987654" required="required">
              ...
              <div class="col-md-4 pl-1">
                <div class="form-group">
                  ...
                  <select  name="tipo"  required="required" class="form-control">
                    ...
                    <option class="text-primary" value="<?=$data['tipo']?>" title="<?=$data['tipo']?>" selected><?=$data['tipo']?></option>
            ...
            <div class="row">
              <div class="col-md-6 pr-1">
                <div class="form-group">
                 ...
                 <input type="tel" name="telefono" value="<?=$data['telefono']?>" title="Solo números sin espacios y símbolos" min="1" max="10000000" class="form-control" placeholder="Ejemplo=10" required="required" pattern="[0-9]{11}">
