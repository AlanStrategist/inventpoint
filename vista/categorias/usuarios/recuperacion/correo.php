...
if (isset($alert) && $alert == "noexiste") {
  $al = new ClassAlert("Error al ingresar!<br>", "Verifique su correo y/o clave", "danger");
} else if (isset($alert) && $alert == "inicia") {
  $al = new ClassAlert("Inicie sesion para continuar!<br>", "", "warning");
} else if (isset($alert) && $alert == "closef") {
  $al = new ClassAlert("Vuelva pronto!<br>", "Cerr&oacute; sessi&oacute;n correctamente", "primary");
} else if (isset($alert) && $alert == "error") {
  $al = new ClassAlert("Error al obtener el correo!<br>", "Comuniquese con el desarrollador", "danger");
} else if (isset($alert) && $alert == "errorv") {
  $al = new ClassAlert("Error!<br>", "El usuario ingresado no tiene un rol v&aacute;lido, Comuniquese con el desarrollador", "danger");
}
      ...
      <div class="col-lg-8 ml-auto mr-auto">
        <div class="card">
          <div class="card-header">
            ...
            <label>
              <h3>InventPoint</h3>
              <span>Ingrese su correo electr&oacute;nico</span>
            </label>
          ...
          <form name="form3" action="../../../../controladores/controladorlogin.php" method="POST" class="form-signin">
            ...
            <input type="hidden" name="operacion" value="view_mail">
