<?php 
$nucleo='Producto';
$title='Modificar Nombre de Ubicación';
...
?>
   ...
   <form method="POST" class="needs-validation"enctype="multipart/form-data" size="30" action="../../../controladores/controladorubicacion.php?operacion=guardar_modificacion" novalidate>
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label for="cod_barra">Nombre</label>
                      <input type="text" name="nombre" title="Nombre de la categoria" minlength="2" maxlength="20" class="form-control" required="required" value="<?=$data['nombre']?>">
