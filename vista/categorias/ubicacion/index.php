...
else if( isset($alert) && $alert == "exito"){ $al = new ClassAlert("Registro exitoso!<br>","","primary"); }
                ...
                <table id="example" class="table">
                  ...
                  while ($data = mysqli_fetch_array($respuesta)) {
                    ...
                    <td><a title="Modificar"
                        href="../../../controladores/controladorubicacion.php?operacion=modificar&id=<?= $data['id'] ?>"><i
