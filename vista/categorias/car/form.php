...
<td><a class="btn btn-md btn-success text-white" title='Tomar datos para generar una factura' data-toggle="modal" data-target="#exampleModalcliente"><strong>Generar Factura</strong></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-info" id="exampleModalLabel">Datos del cliente <i class="fad  fa-id-card"></i></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      	 <form name="formpavo" class='needs-validation' method='POST' action='../../../controladores/controladorpedido.php' novalidate>
    
    
<input type="text" placeholder="Ejemplo:12109387" name="cedula" list="lista" class="form-control" required="required">
...
<input type="date" name="fecha_credi" id="fecha" min="<?=$hoy?>"  class="form-control" required="required" value='<?=$hoy?>' disabled>
