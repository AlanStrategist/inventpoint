...
?>
   ...
   <form method="POST" class="needs-validation"enctype="multipart/form-data" size="30" action="../../../controladores/controladorcategoria.php?operacion=guardar_modificacion" novalidate>
                  <div class="row">
