...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'motocentro');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'respaldo'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE",'motocentro_backup.gz'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
...
class Restore_Database {
    ...
    public function restoreDb() {
        try {
            ...
            */
            $handle = fopen($backupDir . '/' . $backupFile, "respaldo");
            if ($handle) {
