...
<head>
  <meta charset="utf-8" />
  <link rel="icon" type="icon" href="vista/icos/descargar.ico">
...
<body class="offline-doc">
  ...
  <!-- Chart JS -->
  <script src="vista/assets/js/plugins/chartjs.min.js"></script>
  <!--  Notifications Plugin    -->
  <script src="vista/assets/js/plugins/bootstrap-notify.js"></script>
  <!-- Control Center for Now Ui Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="vista/assets/js/now-ui-dashboard.min.js?v=1.5.0" type="text/javascript"></script>
  <!-- Now Ui Dashboard DEMO methods, don't include it in your project! -->
  <script src="vista/assets/demo/demo.js"></script>
</body>
